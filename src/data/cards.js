export const cards = [
...

  {
    ...
    rarity: "Epic",
    element: "Wavebyte",
    frontImage: "/cards/crypto/brooklyn-front.png",
    stats: {
      power: 85,
      speed: 87,
      intelligence: 78,
...

  {
    ...
    rarity: "Legendary",
    element: "Sunpetal",
    frontImage: "/cards/crypto/gemstone-front.png",
    stats: {
      power: 82,
      speed: 76,
      intelligence: 88,
...

  {
    ...
    rarity: "Epic",
    element: "Ghostglitch",
    frontImage: "/cards/crypto/ace-front.png.jpeg",
    stats: {
      power: 81,
      speed: 89,
      intelligence: 85,
...

  {
    ...
    rarity: "Rare",
    element: "Nightwind",
    frontImage: "/cards/crypto/bandit-front.png",
    stats: {
      power: 88,
      speed: 92,
      intelligence: 76,
    ...
    ability: {
      name: "Shadow Dash",
      description:
        "Bandit dashes through the shadows to evade an attack and boosts Speed by +25 for that round.",
    },
  },

  {
    ...
    rarity: "Mythic",
    element: "Dark Nova",
    frontImage: "/cards/crypto/raven-front.png",
    stats: {
      power: 91,
      speed: 82,
      intelligence: 90,
...

  {
    ...
    rarity: "Mythic",
    element: "Starforge",
    frontImage: "/cards/cyber/nukie-front.png",
    stats: {
      power: 78,
      speed: 92,
      intelligence: 86,
...

  {
    ...
    year: 2025,
    rarity: "Legendary",
    element: "Ember Shield",
    frontImage: "/cards/cyber/jinx-front.png",
    stats: {
      power: 89,
      speed: 76,
      intelligence: 83,
...

  {
    ...
    year: 2025,
    rarity: "Epic",
    element: "Lunar Circuit",
    frontImage: "/cards/cyber/elsie-front.png",
    stats: {
      power: 76,
      speed: 81,
      intelligence: 84,
...

  {
    ...
    rarity: "Epic",
    element: "Steel Nova",
    frontImage: "/cards/cyber/metallo-front.png",
    stats: {
      power: 91,
      speed: 68,
      intelligence: 80,
...

  {
    ...
    year: 2025,
    rarity: "Legendary",
    element: "Candy Nebula",
    frontImage: "/cards/cyber/kimiko-front.png",
    stats: {
      power: 82,
      speed: 88,
      intelligence: 91,
...

  {
    ...
    rarity: "Rare",
    element: "Moon Dune",
    frontImage: "/cards/alien/aqualis-front.png",
    stats: {
      power: 73,
      speed: 78,
      intelligence: 71,
...

  {
    ...
    rarity: "Mythic",
    element: "Neon Halo",
    frontImage: "/cards/alien/eclipse-front.png",
    stats: {
      power: 81,
      speed: 76,
      intelligence: 92,
...

  {
    ...
    rarity: "Legendary",
    element: "Aurora Fang",
    frontImage: "/cards/alien/prismfang-front.png",
    stats: {
      power: 89,
      speed: 86,
      intelligence: 83,
...

  {
    ...
    rarity: "Epic",
    element: "Bubble Nova",
    frontImage: "/cards/alien/bloopa-front.png",
    stats: {
      power: 70,
      speed: 69,
      intelligence: 88,
...

  {
    ...
    rarity: "Rare",
    element: "Sky Burst",
    frontImage: "/cards/alien/mintara-front.png",
    stats: {
      power: 68,
      speed: 74,
      intelligence: 77,
...

  {
    ...
    rarity: "Legendary",
    element: "Neon Rage",
    frontImage: "/cards/alien/vexafang-front.png",
    stats: {
      power: 92,
      speed: 88,
      intelligence: 84,
...

  {
    ...
    rarity: "Epic",
    element: "Ghost Bloom",
    frontImage: "/cards/alien/rosette-front.png",
    stats: {
      power: 76,
      speed: 82,
      intelligence: 79,
...

  {
    ...
    rarity: "Rare",
    element: "Dream Mist",
    frontImage: "/cards/alien/blossombyte-front.png",
    stats: {
      power: 69,
      speed: 78,
      intelligence: 85,
...

  {
    ...
    rarity: "Legendary",
    element: "Comet Flare",
    frontImage: "/cards/alien/solaro-front.png",
    stats: {
      power: 83,
      speed: 87,
      intelligence: 82,
...

  {
    ...
    rarity: "Epic",
    element: "Prism Moon",
    frontImage: "/cards/alien/aster-front.png",
    stats: {
      power: 75,
      speed: 84,
      intelligence: 86,
...

  {
    ...
    rarity: "Mythic",
    element: "Twin Orbit",
    frontImage: "/cards/alien/nova&umbra-front.png",
    stats: {
      power: 88,
      speed: 83,
      intelligence: 90,
...

  {
    ...
    ability: {
      name: "Spirit Trail",
      description:
        "Rosette follows a glowing grove spirit, gaining +13 Speed and +10 Luck for one round.",
    },
  },

  {
    id: "alien-mintara-nebula-spirit",
    name: "Mintara",
    pack: "AlienPups",
    series: "AlienPups",
    year: 2025,
    rarity: "Legendary",
    element: "Nebula Spirit",
    frontImage: "/cards/alien/mintara2-front.png",
    stats: {
      power: 77,
      speed: 74,
      intelligence: 92,
...

  {
    ...
    rarity: "Epic",
    element: "Sky Sprout",
    frontImage: "/cards/alien/verdix-front.png",
    stats: {
      power: 74,
      speed: 79,
      intelligence: 84,
...

  {
    ...
    rarity: "Legendary",
    element: "Moon Pop",
    frontImage: "/cards/alien/lunabop-front.png",
    stats: {
      power: 80,
      speed: 82,
      intelligence: 76,
  ...
  {
    id: "alien-aqualis-coral",
    name: "Aqualis",
    pack: "AlienPups",
    series: "AlienPups",
    year: 2025,
    rarity: "Rare",
    element: "Coral Nebula",
    frontImage: "/cards/alien/aqualis2-front.png",
    stats: {
      power: 68,
      speed: 81,
      intelligence: 79,
...

  {
    ...
    year: 2025,
    rarity: "Epic",
    element: "Aurora Bloom",
    frontImage: "/cards/alien/petalia-front.png",
    stats: {
      power: 72,
      speed: 86,
      intelligence: 88,
...

  {
    ...
    year: 2025,
    rarity: "Epic",
    element: "Cosmic Flame",
    frontImage: "/cards/alien/cosmobit-front.png",
    stats: {
      power: 87,
      speed: 91,
      intelligence: 93,
    ...
    ability: {
      name: "Orbital Dash",
      description:
        "Cosmabit dashes in an orbital arc, leaving a trail of cosmic fire that boosts Speed by +20 and Defence by +15 for 2 rounds.",
    },
  },

  {
    ...
    year: 2025,
    rarity: "Epic",
    element: "Starlight Shield",
    frontImage: "/cards/alien/tiko-front.png",
    stats: {
      power: 78,
      speed: 92,
      intelligence: 89,
    ...
    ability: {
      name: "Cosmic Bubble",
      description:
        "Tiko summons a protective starlight bubble that blocks damage and grants +15 Defence to all allies for one round.",
    },
  },

  {
    ...
    rarity: "Epic",
    element: "Lunar Ice",
    frontImage: "/cards/alien/limebyte-front.png",
    stats: {
      power: 82,
      speed: 91,
      intelligence: 87,
    ...
    ability: {
      name: "Frost Byte",
      description:
        "Limebyte unleashes a wave of binary frost, chilling foes and boosting Speed +18 and Defence +14 for one round.",
    },
  },
];
